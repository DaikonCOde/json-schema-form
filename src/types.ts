...
// [fork] Fork-only type extensions live in ./types-ext to keep this core file's
// merge footprint minimal. Re-exported below so internal `../types` imports and
// public consumers are unaffected. See MAINTAINING.md.
import type { AsyncOptionsConfig, JsfLayoutConfig } from './types-ext'
/**
...
// [fork] Fork-only extension types, defined in ./types-ext, re-exported here so
// they remain importable from `../types` (internal) and from the package root.
export type {
  AsyncOptionsConfig,
  AsyncOptionsLoader,
